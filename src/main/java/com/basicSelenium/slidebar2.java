...
public class slidebar2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement slider = driver.findElement(By.xpath("//div[@id='layered_price_slider']//a[@class='ui-slider-handle ui-state-default ui-corner-all'][2]"));
		Actions builder = new Actions(driver);
		int iCount = 0;
		int iRange=30;
		if (iRange > 0) {
			for (iCount = iRange; iCount > 0; iCount--) {
				builder.click(slider).sendKeys(Keys.ARROW_DOWN).perform();
			}
		}
